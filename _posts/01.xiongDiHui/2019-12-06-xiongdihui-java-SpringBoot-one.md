...
–IntelliJIDEA2019：IntelliJ IDEA 2019.2 x64

–SpringBoot 2.2.2.RELEASE：2.2.2；
...
![idea设置](/assets/images/搜狗截图20180129151045.png)



![images/](/assets/images/搜狗截图20180129151112.png)
...
​       会给容器中导入非常多的自动配置类（xxxAutoConfiguration）；就是给容器中导入这个场景需要的所有组件，并配置好这些组件；        ![自动配置类](/assets/images/搜狗截图20180129224104.png)
...
J2EE的整体整合解决方案和自动配置都在spring-boot-autoconfigure-2.2.2.RELEASE.jar；
