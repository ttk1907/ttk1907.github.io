...
# 任务2、自定义MVC框架
## 第三部分 ⼿写 MVC 框架
### 3.1 SpringMVC执⾏的⼤致原理
![回顾mvc流程](/assets/lagou/第一阶段/第三模块/回顾mvc流程.jpg)
            ...
            for (int i = 0; i < methods.length; i++) {
                ...
                for (int j = 0; j < parameters.length; j++) {
                    ...
                    if(parameter.getType() == HttpServletRequest.class ||parameter.getType() == HttpServletResponse.class) {
                        // 如果是request和response对象，那么参数名称写 HttpServletRequest和HttpServletResponse
