...
http请求的处理过程  
![http请求处理过程](/assets/第二阶段/01.第一模块/http请求处理过程.jpg)
...
![tomcat系统架构](/assets/第二阶段/01.第一模块/tomcat系统架构.jpg)  

![tomcat系统处理请求](/assets/第二阶段/01.第一模块/tomcat系统处理请求.jpg)
...
![TomcatServlet容器处理流程](/assets/第二阶段/01.第一模块/TomcatServlet容器处理流程.jpg)
...
![Tomcat组件](/assets/第二阶段/01.第一模块/Tomcat组件.jpg)  
...
![Coyote](/assets/第二阶段/01.第一模块/Coyote.jpg)  

Tomcat Coyote ⽀持的 IO模型与协议  

Tomcat⽀持多种应⽤层协议和I/O模型，如下：  
![协议](/assets/第二阶段/01.第一模块/协议.jpg)  
...
![Coyote的内部组件及流程](/assets/第二阶段/01.第一模块/Coyote的内部组件及流程.jpg)  
...
![Tomcat模块分层结构图及Catalina位置](/assets/第二阶段/01.第一模块/Tomcat模块分层结构图及Catalina位置.jpg)  
...
Tomcat/Catalina实例  
![TomcatCatalina实例](/assets/第二阶段/01.第一模块/TomcatCatalina实例.jpg)  
